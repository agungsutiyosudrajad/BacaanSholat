...
class _AyatKursiState extends State<AyatKursi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 59, 85, 75),
      body: SafeArea(
        child: Column(
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color: Color.fromRGBO(163, 181, 164, 0.418)),
                    height: 200,
                  ...
                  child: Padding(
                    ...
                    child: Material(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(50),
                            color: Color.fromARGB(255, 78, 86, 80)),
                        child: Material(
                          borderRadius: BorderRadius.circular(50),
                          color: Colors.transparent,
                          child: InkWell(
                            splashColor: Color.fromARGB(255, 240, 238, 234),
                            borderRadius: BorderRadius.circular(50),
                            onTap: () {
                              showDialog(
                                  context: context,
